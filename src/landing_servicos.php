            ...
            <div class="container">
                <div class="row wow fadeInUp">
                    <div class="col-xs-12 col-sm-10 col-sm-offset-1 text-center">
                        <div class="jumbotron">
                            <h1 class="text-white">Serviços disponíveis</h1>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-md-10 pull-right">
                    ...
                    <form action="servicos.php">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Digite o serviço">
                        ...
                        <div class="pull-right col-xs-12 col-sm-7 col-md-6">
                            <form class="form-horizontal">
                                <div class="form-group">
                                    <label class="control-label col-xs-4" for="sort">Ordenado por : </label>
                                    <div class="col-xs-8">
                                        <div class="form-group">
                                ...
                                <div class="category-item well yellow">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="space-10"></div>
                                            <a href="view_landing_servico.php?servico_id=<?php echo $row->servico_id;?>" class="text-primary">Ver Serviço</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-xs-12 col-md-2">
                    <aside>
                        <h3><i class="icofont icofont-filter"></i> Filtrar Por</h3>
                        <div class="space-30"></div>
                        <div class="sigle-sidebar">
                            ...
                            <a href="#" class="btn btn-primary btn-xs">Ver Tudo</a>
                        </div>
                        <div class="space-20"></div>
                    </aside>
                </div>
